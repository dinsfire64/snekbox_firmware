...
#define POKKEN_CONTROLLER false
...
#define BCDDEVICE_XINPUT 0x0214

// pokken uses a specific hori xinput pad with this vid/pid combo
// the arcade game requires it to pass usb error 2.
#define VID_POKKEN_XINPUT 0x0F0D
#define PID_POKKEN_XINPUT 0x0073
#define BCDDEVICE_POKKEN_XINPUT 0x0102
